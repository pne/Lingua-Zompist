...
form_ok('ggg', adj('ggg'), [ [ qw( ggg gggei ggg gggán
                                   gggî gggië gggi gggin ) ],
                             [ qw( ggga ggge ggga gggan
                                   gggî gggië gggem gggen ) ] ]);
form_ok('ggge', adj('ggge'), [ [ qw( ggge gggei gggem gggen
                                     gggî gggeë gggem gggein ) ],
                               [ qw( gggë gggëi gggä gggen
                                     gggî gggië gggem gggen ) ] ]);
form_ok('gggy', adj('gggy'), [ [ qw( gggy gggii gggim gggín
                                     gggî ggguë gggom ggguin ) ],
                               [ qw( gggy gggye gggya gggyan
                                     gggî gggyië gggyem gggyen ) ] ]);
form_ok('gggë', adj('gggë'), [ [ qw( gggë gggëi gggä gggén
                                     gggëi gggëë gggóm gggëin ) ],
                               [ qw( ggga ggge ggga gggan
                                     gggî gggië gggem gggen ) ] ]);
